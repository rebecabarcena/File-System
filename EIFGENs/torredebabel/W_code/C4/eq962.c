...
extern void F962_8217(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F962_8218(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
void F962_8218 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x)
{
	GTCX
...
#define arg4 arg4x.it_i4
	...
	RTEAA(l_feature_name, 961, Current, 0, 4, 13645);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(961, Current, 13645);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("a_body_id_not_negative", EX_PRE);
