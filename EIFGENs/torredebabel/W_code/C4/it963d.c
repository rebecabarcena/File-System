...
static const EIF_TYPE_INDEX egt_13_963 [] = {250,0,0xFFFF};
static const EIF_TYPE_INDEX egt_14_963 [] = {0xFF01,250,0,0xFFFF};
static const EIF_TYPE_INDEX egt_15_963 [] = {0xFF01,377,191,0xFFFF};
...
static const struct desc_info desc_963[] = {
	...
	{EIF_NON_GENERIC(0x017F /*191*/), 13648, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x017F /*191*/), 13649, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01 /*0*/), 13650, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01 /*0*/), 13651, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 13652, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 13653, 0xFFFFFFFF},
	{EIF_GENERIC(egt_13_963), 13654, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_963), 13655, 0},
	{EIF_GENERIC(egt_15_963), 13656, 8},
...
void Init963(void)
{
	...
	IDSC(desc_963 + 32, 39, 962);
	IDSC(desc_963 + 35, 387, 962);
}
