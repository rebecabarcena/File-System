...
extern EIF_TYPED_VALUE F893_7106(EIF_REFERENCE);
extern EIF_TYPED_VALUE F893_7107(EIF_REFERENCE);
extern EIF_TYPED_VALUE F893_7109(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F893_7368(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F893_7106 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 892, Current, 0, 0, 12804);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(892, Current, 12804);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F893_7107 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 892, Current, 0, 0, 12805);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(892, Current, 12805);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F893_7109 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 892, Current, 0, 1, 12806);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(892, Current, 12806);
	RTIV(Current, RTAL);
