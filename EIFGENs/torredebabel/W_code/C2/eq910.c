...
extern void F910_7568(EIF_REFERENCE);
extern EIF_TYPED_VALUE F910_7569(EIF_REFERENCE);
extern EIF_TYPED_VALUE F910_7570(EIF_REFERENCE);
extern void F910_7571(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F910_7572(EIF_REFERENCE);
extern void F910_7573(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F910_7574(EIF_REFERENCE);
extern EIF_TYPED_VALUE F910_7575(EIF_REFERENCE);
extern void F910_9459(EIF_REFERENCE, int);
...
void F910_7568 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 909, Current, 0, 0, 13058);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(909, Current, 13058);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5358, 0xF80000DC, 0); /* buffer */
	...
	RTNHOOK(1,1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(5358, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F910_7571 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 909, Current, 0, 1, 13061);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(909, Current, 13061);
	RTIV(Current, RTAL);
...
void F910_7572 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 909, Current, 0, 0, 13062);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(909, Current, 13062);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F910_7573 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 909, Current, 2, 1, 13063);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(909, Current, 13063);
	RTCC(arg1, 909, l_feature_name, 1, eif_new_type(218, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		...
		if ((EIF_BOOLEAN)(loc2 != (EIF_CHARACTER_8) '\015')) {
			...
			if ((EIF_BOOLEAN) ((EIF_BOOLEAN)(loc2 == (EIF_CHARACTER_8) '\012') && (EIF_BOOLEAN) !tb1)) {
				...
				if (tb1) {
					RTHOOK(11);
					uc1 = loc2;
					(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5360, dtype))(Current, uc1x);
					RTHOOK(12);
...
void F910_7574 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 909, Current, 0, 0, 13064);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(909, Current, 13064);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5358, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	...
	if ((EIF_BOOLEAN) !tb2) {
		tb2 = *(EIF_BOOLEAN *)(Current + RTWA(5359, dtype));
		tb1 = (EIF_BOOLEAN) !tb2;
	}
	if (tb1) {
		RTHOOK(2);
...
EIF_TYPED_VALUE F910_7575 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 909, Current, 0, 0, 13065);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(909, Current, 13065);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F910_9459 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 909, Current, 0, 9458);
	RTSA(dtype);
	RTME(dtype, 0);
