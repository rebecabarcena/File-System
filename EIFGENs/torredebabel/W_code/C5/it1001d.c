...
static const EIF_TYPE_INDEX egt_13_1001 [] = {0xFF01,220,0xFFFF};
...
static const struct desc_info desc_1001[] = {
	...
	{EIF_NON_GENERIC(0x019D /*206*/), 14499, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x017F /*191*/), 8401, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 14497, 0xFFFFFFFF},
	{EIF_GENERIC(egt_13_1001), 14498, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x019D /*206*/), 14501, 0},
...
void Init1001(void)
{
	...
	IDSC(desc_1001 + 32, 248, 1000);
	IDSC(desc_1001 + 34, 409, 1000);
	IDSC(desc_1001 + 37, 408, 1000);
}
