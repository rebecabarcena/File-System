...
extern EIF_TYPED_VALUE F956_8141(EIF_REFERENCE);
extern EIF_TYPED_VALUE F956_8142(EIF_REFERENCE);
extern EIF_TYPED_VALUE F956_8143(EIF_REFERENCE);
extern void F956_8144(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F956_8141 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 955, Current, 1, 0, 13580);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(955, Current, 13580);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5890, Dtype(Current)))(Current, up1x);
	RTHOOK(3);
...
RTOID (F956_8142)
EIF_TYPED_VALUE F956_8142 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 955, Current, 0, 0, 13581);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(955, Current, 13581);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F956_8143)
EIF_TYPED_VALUE F956_8143 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 955, Current, 0, 0, 13582);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(955, Current, 13582);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80003BE, 0,0); /* Result */
...
void F956_8144 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 955, Current, 0, 1, 13583);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(955, Current, 13583);
...
{
	GTCX
	RTOTS (8142,F956_8142)
	RTOTS (8143,F956_8143)
}
