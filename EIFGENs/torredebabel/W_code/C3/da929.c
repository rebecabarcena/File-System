...
extern EIF_TYPED_VALUE F929_7875(EIF_REFERENCE);
extern EIF_TYPED_VALUE F929_7876(EIF_REFERENCE);
extern EIF_TYPED_VALUE F929_7877(EIF_REFERENCE);
extern EIF_TYPED_VALUE F929_7878(EIF_REFERENCE);
extern EIF_TYPED_VALUE F929_7879(EIF_REFERENCE);
extern EIF_TYPED_VALUE F929_7880(EIF_REFERENCE);
extern EIF_TYPED_VALUE F929_7881(EIF_REFERENCE);
extern EIF_TYPED_VALUE F929_7882(EIF_REFERENCE);
...
EIF_TYPED_VALUE F929_7875 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F929_7875,13344,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F929_7876)
EIF_TYPED_VALUE F929_7876 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 928, Current, 0, 0, 13344);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(928, Current, 13344);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {243,0xFF01,220,0xFFFF};
		EIF_TYPE typres0;
...
RTOID (F929_7877)
EIF_TYPED_VALUE F929_7877 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 928, Current, 0, 0, 13345);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(928, Current, 13345);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000FA, 0,0); /* Result */
...
RTOID (F929_7878)
EIF_TYPED_VALUE F929_7878 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 928, Current, 0, 0, 13346);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(928, Current, 13346);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000FA, 0,0); /* Result */
...
RTOID (F929_7879)
EIF_TYPED_VALUE F929_7879 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 928, Current, 0, 0, 13347);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(928, Current, 13347);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000FA, 0,0); /* Result */
...
EIF_TYPED_VALUE F929_7880 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F929_7880,13349,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F929_7881 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F929_7881,13350,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F929_7882 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F929_7882,13351,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit929 (void)
{
	GTCX
	RTOTS (7875,F929_7875)
	RTOTS (7876,F929_7876)
	RTOTS (7877,F929_7877)
	RTOTS (7878,F929_7878)
	RTOTS (7879,F929_7879)
	RTOTS (7880,F929_7880)
	RTOTS (7881,F929_7881)
	RTOTS (7882,F929_7882)
}
