...
static const EIF_TYPE_INDEX egt_13_945 [] = {0xFF01,928,0xFFFF};
static const EIF_TYPE_INDEX egt_14_945 [] = {0xFF01,220,0xFFFF};
static const EIF_TYPE_INDEX egt_15_945 [] = {0xFF01,220,0xFFFF};
...
static const struct desc_info desc_945[] = {
	...
	{EIF_GENERIC(egt_13_945), 13493, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_945), 13494, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_15_945), 13500, 0xFFFFFFFF},
...
void Init945(void)
{
	...
	IDSC(desc_945 + 32, 446, 944);
	IDSC(desc_945 + 36, 441, 944);
	IDSC(desc_945 + 42, 433, 944);
}
