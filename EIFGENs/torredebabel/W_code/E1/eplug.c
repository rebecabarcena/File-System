...
void egc_init_plug (void)
{
	...
	egc_system_name = "torredebabel";
	egc_system_location = "R:\\UC\\Dise\303\261o SW\\Pr\303\241cticas\\Torre de Babel\\TorreDeBabel\\EIFGENs\\torredebabel\\W_code";
	egc_compiler_tag = 38;
	egc_project_version = 1448063011;
...
void egc_rcdt_init (void)
{
	if (egc_rcdt[0] == 0) {
		...
		egc_rcdt[1] = 977; /* EQA_EVALUATOR */
	}if (egc_rcdt[2] == 0) {
		egc_rcdt[2] = 1016; /* ITP_INTERPRETER */
	}
}
