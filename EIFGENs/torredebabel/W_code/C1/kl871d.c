...
static const struct desc_info desc_871[] = {
	...
	{EIF_GENERIC(egt_14_871), 12700, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_871), 12701, 0xFFFFFFFF},
	{EIF_GENERIC(egt_16_871), 12702, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x017F /*191*/), 12703, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x017F /*191*/), 12704, 0xFFFFFFFF},
	{EIF_GENERIC(egt_17_871), 12705, 0xFFFFFFFF},
	{EIF_GENERIC(egt_18_871), 12706, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 12707, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 12708, 0xFFFFFFFF},
	{EIF_GENERIC(egt_19_871), -1, 0xFFFFFFFF},
};
void Init871(void)
{
	IDSC(desc_871, 0, 870);
	IDSC(desc_871 + 1, 1, 870);
	IDSC(desc_871 + 32, 363, 870);
	IDSC(desc_871 + 33, 356, 870);
}
